...
const SALES_BUDGET_2026 = {
    ...
    "RAMIREZ PEREZ MARIA": { cif: 285000000, total: 312600000 },
...
const REPORT_CONFIG_2026 = {
    ...
    "ZONA 02": [
        ...
        { name: "RAMIREZ PEREZ MARIA", annual: 285000000, monthly: 23750000 },
...
function updateVendorBrandInsights(periodData, ytdDataHist, monthsPassed = 1) {
    ...
    renderConsolidatedVendorTable(vendorMap, ytdVendorMap, monthsPassed);
}
...
function renderConsolidatedVendorTable(periodMap, ytdMap, monthsPassed) {
    const tableSelector = '#vendors-consolidated-table';
    const footerIds = { 
...
if (document.getElementById('mes')) {
    document.getElementById('mes').addEventListener('change', handleMonthYearChange);
}

if (document.getElementById('anio')) {
    document.getElementById('anio').addEventListener('change', handleMonthYearChange);
}
